...
guit_chord.set('02220-', 'a_maj');
guit_chord.set('22220-', 'a_6');
guit_chord.set('32220-', 'a_7');
guit_chord.set('556775', 'a_bar'); // no uke equivalent atm -- 
guit_chord.set('03220-', 'a_sus');
guit_chord.set('-5454-', 'a_dom_7_9'); // no uke equivalent atm
guit_chord.set('01220-', 'a_min');
guit_chord.set('', 'a_min_6'); // no uke equivalent atm
guit_chord.set('31220-', 'a_min_7'); 
...
guitar_chord.set('1213--', '');
guitar_chord.set('7666- ', '');
guitar_chord.set('0212--', '');
guitar_chord.set('9 9 10 11 11 9', ''); // DOUBLE DIGIT FRETS
guitar_chord.set('02122-', '');
guitar_chord.set('--664-', ''); 
guitar_chord.set('-2121-', ''); 
