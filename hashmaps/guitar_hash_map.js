...
guit_chord.set('2234--', 'g_flat_maj');
guit_chord.set('223442', 'g_flat_bar');
guit_chord.set('223242', 'g_flat_7');
guit_chord.set('222442', 'g_flat_min');
guit_chord.set('252242', 'g_flat_min_7'); 
guit_chord.set('222242', 'g_flat_min_7_var_2'); // does this cause a collission?
guit_chord.set('- 11 11 11 9 - ', 'g_flat_maj_var_2'); // no ukulele equivalent atm -- DOUBLE DIGIT FRETS -- SHOULD IT BE CONSIDERED FIRST OCTAVE?
guit_chord.set('---442', 'g_flat_5');
guit_chord.set('-2121-', 'g_flat_9');
guit_chord.set('999999', 'g_flat_11');
guit_chord.set('', 'g_flat_dim'); 										
guit_chord.set('', 'g_flat_dim_7'); 										
guit_chord.set('', 'g_flat_aug'); 										
guit_chord.set('', 'g_flat_9'); 											
guit_chord.set('', 'g_flat_add_9');


// C SHARP (D FLAT) FIRST OCTAVE FAMILY

guitar_chord.set('1213--', 'd_flat_maj');
guitar_chord.set('7666- ', 'd_flat_7');
guitar_chord.set('0212--', 'd_flat_min');
guitar_chord.set('9 9 10 11 11 9', 'd_flat_maj_inv_3'); // DOUBLE DIGIT FRETS
guitar_chord.set('02122-', 'd_flat_min_7');
guitar_chord.set('--664-', ''); //power chord
guitar_chord.set('-2121-', ''); // no idea why i put this here. don't know what it is. 
guitar_chord.set('44434-', ''); // ^
guit_chord.set('', 'g_flat_dim'); 										
guit_chord.set('', 'g_flat_dim_7'); 										
guit_chord.set('', 'g_flat_aug'); 										
guit_chord.set('', 'g_flat_9'); 											
...
guitar_chord.set('3431--','e_flat_maj');
guitar_chord.set('-4656-','e_flat_7');
guitar_chord.set('2324--','e_flat_min');
guitar_chord.set('-4344-','e_flat_min_7');
// guitar_chord.set('11 11 12 13 13 11','d_sharp_e_flat_maj_var_2'); DOUBLE DIGIT FRETS
guitar_chord.set('2121--','e_flat_dim');
guitar_chord.set('443---','e_flat_sus');
guitar_chord.set('-1011-','e_flat_6');										
guit_chord.set('', 'e_flat_dim_7'); 										
guit_chord.set('', 'e_flat_aug'); 										
guit_chord.set('', 'e_flat_9'); 											
guit_chord.set('', 'e_flat_add_9');

guit_chord.set('-3331-', 'b_flat_maj');
guit_chord.set('4333--', 'b_flat_7');
guit_chord.set('123311', 'b_flat_min');
guit_chord.set('6666--', 'b_flat_min_7');
guit_chord.set('667886', 'b_flat_maj_var_2');
guit_chord.set('33331-', 'b_flat_6');
guit_chord.set('1110--', 'b_flat_9');
guit_chord.set('', 'b_flat_dim');
guit_chord.set('', 'b_flat_dim_7'); 										
guit_chord.set('', 'b_flat_aug'); 	
guit_chord.set('', 'b_flat_add_9');																				
